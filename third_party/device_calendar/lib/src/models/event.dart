...
class Event {
  ...
  Event.fromJson(Map<String, dynamic>? json) {
    ...
    // Patched: tolerate a missing/null availability. iOS local calendars (and
    // the Simulator's default calendar) don't support availability, so the
    // native side sends null here — the upstream non-nullable signature then
    // throws a TypeError mid-parse. See third_party/device_calendar/README_PATCH.md.
    availability = parseStringToAvailability(json['availability'] as String?);
